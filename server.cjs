...
const files={'/quiz-bank.js':'quiz-bank.js','/program.js':'program.js','/robot-sheet.js':'robot-sheet.js','/assets/campus-lite.jpg':'assets/campus-lite.jpg','/assets/teacher-lan-lite.png':'assets/teacher-lan-lite.png','/assets/robot-xiaoda-lite.png':'assets/robot-xiaoda-lite.png','/assets/campus.png':'assets/campus.png','/assets/teacher-lan.png':'assets/teacher-lan.png','/assets/robot-xiaoda.png':'assets/robot-xiaoda.png','/':'index.html','/demo':'index.html','/test':'index.html','/index.html':'index.html','/app.js':'app.js','/story.js':'story.js','/scene.js':'scene.js','/sync.js':'sync.js','/style.css':'style.css','/rules.js':'rules.js','/teacher':'teacher.html','/teacher.html':'teacher.html','/teacher.js':'teacher.js'};
